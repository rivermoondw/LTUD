...
exports.postAdd = function(req, res) {
	if (req.body.submit){
		var date = new Date();
		var fields = ['email', 'password', 'name', 'role_id', 'created_at', 'updated_at'];
		var data = [req.body.email, req.body.password, req.body.name, parseInt(req.body.role_id), date, date];
